...
<div class="than" >
    <div >
        ...
        <div  style="float:none; text-align:justify; line-height:35px">
            Tên chủ xe: <b>Phạm Văn Hoan </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Năm sinh:<b>1989</b>
            <br />
            Số CMND:&nbsp;<b>152275879</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cấp ngày:&nbsp;<b>14/05/2014</b> &nbsp;&nbsp;&nbsp; tại:&nbsp;<b>CA Thái Bình</b>
            <br />
            ...
            <br />
            Số CMND/Thẻ CCCD:<b>{{$thongtinKhachHang->so_CMND}}</b>&nbsp;&nbsp;&nbsp;Cấp ngày:&nbsp<b>&nbsp;{{date("d/m/Y", strtotime($thongtinKhachHang->cap_ngay))}}</b>&nbsp;&nbsp;tại:&nbsp<b>{{$thongtinKhachHang->noi_cu_tru}}</b>
        </div>
