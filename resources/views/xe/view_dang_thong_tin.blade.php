                            ...
                            <div class="form-group">
                                ...
                                @foreach($loaiXe as $lx)
                                    @if($thongTinXe[0]['dongxe']['iMa_loai_xe'] == $lx->id)
                                        <input type="text" class="form-control"  placeholder="Loại xe"  value=" {{$lx->ten_loai_xe}}" disabled>
                                    @endif
                                @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="so_km_di" id="so_km_di" placeholder="Số km đã đi"  value="{{$thongTinXe[0]['so_km_da_di']}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" style="padding-top: 10px;">
                                ...
                                <textarea class="form-control" rows="9" name="ghi_chu" >{{$thongTinXe[0]['ghi_chu']}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
