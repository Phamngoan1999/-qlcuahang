...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="luu-dich-vu" data-url="{{route("quanlysuachua.list-dich-vu-select-update")}}">Lưu dịch vụ</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="module" src="{{asset('js/admin/update_hoa_don.js')}}"></script>
@endsection
